package uni.fmi.dmitry.applibrary;
...
import uni.fmi.bachelors.applibrary.R;

public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyCustomAdapter> {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyCustomAdapter holder, final int position) {
